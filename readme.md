...
## DONE 1: Our API should be able to process new User registrations. 
...
## DONE 2: Our API should be able to process User logins.
...
## DONE 3: Our API should be able to process the creation of new messages.
...
## DONE 4: Our API should be able to retrieve all messages.

As a user, I should be able to submit a GET request on the endpoint GET localhost:8080/messages.

- The response body should contain a JSON representation of a list containing all messages retrieved from the database. It is expected for the list to simply be empty if there are no messages. The response status should always be 200, which is the default.

## DONE 5: Our API should be able to retrieve a message by its ID.
...
## DONE 6: Our API should be able to delete a message identified by a message ID.
...
## DONE 7: Our API should be able to update a message text identified by a message ID.
